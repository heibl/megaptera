...
ncbiLineage <- function(taxon, kingdom, megapteraProj){
  ...
  repeat {
    ...
    ## check for existance of taxon name in both Metazoa and 
    ...
    ##
    if ( megapteraProj@params@parallel ) {
      # sfLibrary(megaptera)
      sfInit(parallel = TRUE, 
             cpus = megapteraProj@params@cpus, 
             type = megapteraProj@params@cluster.type)
      sfExport("xml")
